...
where
  cdrb.msg_id = cdr.msg_id
  AND cdrb.msg_id2 = cdr.msg_id2
  AND cdrb.msg_id_serv = cdr.msg_id_serv
  and cdrb.trans_dt > '14/09/16' -- lmf
  and cdrb.trans_dt < '15/09/16' -- lmf
  and bi.bill_ref_no = cdrb.bill_ref_no
...
--AND TO_CHAR(cdr.trans_dt, 'yyyy-mm-dd hh:mm:ss') BETWEEN '2016-09-14 09:00:00' AND  '2016-09-14 12:00:00'
  --and TO_CHAR(cdr.trans_dt, 'yyyy-mm-dd hh:mm:ss') < '2016-09-14 12:00:00'